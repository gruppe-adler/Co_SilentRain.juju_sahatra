...
class nadia_confused_1_fear
{
	...
	titles[] = {
			0, "<t color='#ffffff' shadow='2'>What are you doing</t>"
		};
...
class nadia_greet_1_calm
{
	...
	titles[] = {
			0, "<t color='#ffffff' shadow='2'>Hey boys</t>"
		};
...
class nadia_quasimlove_2_seduce
{
...
class nadia_quasimlove_3_seduce
{
...
class nadia_quasimlove_4_seduce
{
...
class nadia_quasimlove_5_seduce
{
