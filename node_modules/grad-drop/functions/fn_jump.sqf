...

{
    ...
    grad_screenshotmode_fnc_toggleACENametags,
    grad_screenshotmode_fnc_toggleSTHud,
    grad_screenshotmode_fnc_toggleTFAR,
    grad_screenshotmode_fnc_toggleVanillaHUD,
    grad_screenshotmode_fnc_toggleDuiHud
];
...
// disable plane sounds locally --> disabling simulation doesnt work sadly
/*
...
// todo create replacement sounds that move away/fadeout --> not necessary anymore imo
