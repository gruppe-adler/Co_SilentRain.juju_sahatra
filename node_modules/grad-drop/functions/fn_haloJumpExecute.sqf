...
private _planesPrepared = missionNameSpace getVariable ["GRAD_drop_planesPrepared", []];
{
	...
	[_planeInSky, _waitBeforeJump, _onSceneCut, _onLanding, _giveParachute] call grad_drop_fnc_movePlayersInside;	
	[_planeInSky, _waitBeforeJump, _onLanding] spawn grad_drop_fnc_startProcedure;
