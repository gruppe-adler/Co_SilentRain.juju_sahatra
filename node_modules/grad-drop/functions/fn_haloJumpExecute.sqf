...
// simulate start 
{
	...
	[_planeInBase, false] remoteExec ["grad_drop_fnc_simulateSound", [0,-2] select isDedicated, _planeInBase];
	[_planeInSky, false] remoteExec ["grad_drop_fnc_simulateSound", [0,-2] select isDedicated, _planeInSky];
} forEach _planesPrepared;
