...
private _soundSourceLeft = createSoundSource ["c130_sound_int_forsage", position _plane, [], 0];
_soundSourceLeft attachTo [_soundDummyLeft, [0,0,0]];

private _soundSourceRight = createSoundSource ["c130_sound_int_forsage", position _plane, [], 0];
_soundSourceRight attachTo [_soundDummyRight,[0,0,0]];
