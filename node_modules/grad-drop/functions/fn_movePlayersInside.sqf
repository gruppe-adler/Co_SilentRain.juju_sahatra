...
[{
    ...
    diag_log format ["moveplayersinside: attachedObjects in skyplane: %1", count attachedObjects _attachHelper];
        [{
            ...
            private _attachHelperSky = _planeInSky getVariable ["grad_drop_attachHelperSky", objNull];
            private _allPlayersAttached = attachedObjects _attachHelper;
            {
                private _offset = (_x worldToModelVisual ASLToAGL (getPosWorld _attachHelper));
                detach _x;
                _x attachTo [_attachHelperSky, _offset];
            } forEach _allPlayersAttached;


             private _y = getDir _planeInBase + 180; private _p = 0; private _r = 0; 
            _attachHelperSky setVectorDirAndUp [ 
...
}, [_attachHelper, _planeInSky, _planeInBase]] call CBA_fnc_waitUntilAndExecute;
