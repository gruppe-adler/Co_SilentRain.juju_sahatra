...
// spawn static planes to prepare them in position
{
	...
	_attachHelper setDir getDir _planeInBase;
	...
	private _attachHelperSky = "Sign_Sphere10cm_F" createVehicle [0,0,0];
	_attachHelperSky setObjectTextureGlobal [0, "#(rgb,8,8,3)color(0,0,0,0)"];
	_attachHelperSky setPos (_planeInSky modelToWorld [0,0,0.3]);
	_attachHelperSky setDir getDir _planeInSky;
	_planeInSky setVariable ["grad_drop_attachHelperSky", _attachHelperSky, true];
