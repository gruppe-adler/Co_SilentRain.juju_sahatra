...
params ["_planeInBase", "_waitBeforeJump", "_onLanding"];
...
private _soundPlane = _planeInSky getVariable ["grad_drop_soundplane", objNull];
...
[_planeInSky, _onLanding] remoteExec ["grad_drop_fnc_jump",0,false];
...
_planeInSky setVariable ["grad_drop_lightStatus","RED",true];
...
_planeInSky animate ["ramp_top", 0];
_planeInSky animate ["ramp_bottom", 0];
...
_planeInSky setVariable ["grad_drop_lightStatus","GREEN",true];
...
// todo insert check when players have all jumped

sleep 3;

_planeInSky setVariable ["grad_drop_lightStatus","DELETE",true];
sleep 0.5;
private _posCache = getPos _planeInSky;
private _dirCache = getDir _planeInSky;
