...
params ["_plane", "_waitBeforeJump", "_onLanding"];

private _jm = _plane getVariable ["grad_drop_jumpmaster", objNull];
private _planeLights = _plane getVariable ["grad_drop_lights", []];
private _soundPlane = _plane getVariable ["grad_drop_soundplane", objNull];
...
[_plane, _onLanding] remoteExec ["grad_drop_fnc_jump",0,false];
...
waitUntil {
    _plane getVariable ["grad_drop_playersInside", []] == []
};
