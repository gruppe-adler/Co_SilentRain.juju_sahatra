...
private _attachHelper = _planeInSky getVariable ["grad_drop_attachHelper", objNull];
...
waitUntil { count (attachedObjects _attachHelper) < 1 };
...
[_jm, "grad_drop_jm0", 65] remoteExec ["grad_drop_fnc_playSound",0,false];
...
[_jm, "grad_drop_jm1", 65] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 5;

[_jm, "grad_drop_jm2", 65] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 10;

[_jm, "grad_drop_jm3", 65] remoteExec ["grad_drop_fnc_playSound",0,false];


sleep 10;

[_jm, "grad_drop_jm4", 65] remoteExec ["grad_drop_fnc_playSound",0,false];
...
[_jm,"grad_drop_rearDoor", 65] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 1.3;


[_jm, "grad_drop_jm5", 65] remoteExec ["grad_drop_fnc_playSound",0,false];
...
[_jm, "grad_drop_jm6", 65] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 3;

[_jm, "grad_drop_jm7", 65] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 3.5;

[_jm, "grad_drop_jm8", 65] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 3;

[_jm, "grad_drop_jm9", 65] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 3.5;

[_jm, "grad_drop_jm10", 65] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 3;

[_jm, "grad_drop_jm11", 65] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 5;

[_jm, "grad_drop_jm12", 65] remoteExec ["grad_drop_fnc_playSound",0,false];
