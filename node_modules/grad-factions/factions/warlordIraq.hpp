...
class warLordIraq: Taliban {
	  class AllUnits {
		    uniform = "UK3CB_KRG_B_U_Crew_Uniform_02_DDPM";
		    vest = "UK3CB_V_Chicom_Desert";
		    backpack = "";
		    headgear = "UK3CB_ADE_O_H_Turban_01_1";
    ...
    class Type {
        //Rifleman
        class Soldier_F {
            uniform = "UK3CB_KRG_B_U_Crew_Uniform_01_DDPM";
            addItemsToUniform[] = {
              LIST_2("ACE_Cabletie"),
		...
		class officer_F: Soldier_F {
			...
			secondaryWeapon = "rhs_weap_savz61_folded";
			secondaryWeaponMagazine = "rhsgref_20rnd_765x17_vz61";
            uniform = "U_O_ParadeUniform_01_CSAT_decorated_F";
